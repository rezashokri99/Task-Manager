        ...
        <div className={styles.sidebarContainer}>
            ...
            <div className={styles.menuContainer}>
                <ul>
                    ...
                    <li><a href="https://github.com/rezashokri99" target="_blank"><BsGithub /> <span>GitHub</span></a></li>
                    <li><a href="https://www.instagram.com/reza_shokri99/" target="_blank"><BsInstagram /> <span>Instagram</span></a></li>
                    <li><a href="https://www.linkedin.com/in/reza-shokri-9983581b9/" target="_blank"><GrLinkedinOption /> <span>Linkedin</span></a></li>
                </ul>
                <ul>
